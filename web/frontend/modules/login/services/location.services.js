unlimty.factory("load_pais_prov_poblac", ['services', '$q',
function (services, $q) {
    var service = {};
    ...
    function loadProvincia() {
        var deferred = $q.defer();
        services.get("login", "load_provincias_user", true).then(function (data) {
            //console.log(data);
            if (data === 'error') {
    ...
    function loadPoblacion(datos) {
        var deferred = $q.defer();
        services.post("login", "load_poblaciones_user", datos).then(function (data) {
            //console.log(data);
            if (data === 'error') {
